...
const getDepartmentsByCollegeId = async (req, res) => {
  try {
    ...
    const departments = await Department.findAll({
      where: {
        id: departmentIds, // Fetch departments where departmentId is in the array of departmentIds
      },
      attributes: ["id", "department_name", "icon"], // Select the fields you need
    });
...
const searchDepartment = async (req, res) => {
  try {
    ...
    const dept = await Department.findAll({
      ...
      attributes: ["id", "department_name", "icon"],
    });
